    ...
    <Jumbotron className="bg-dark">
      ...
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://moviefive.herokuapp.com" target="_blank" color="primary"><i class="far fa-eye"></i> Live Site</Button> <Button href="https://github.com/5-28-a/group-project" target="_blank" color="primary"><i className="fas fa-code"></i> View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://nannerfox.herokuapp.com" target="_blank" color="primary"><i class="far fa-eye"></i> Live Site</Button> <Button href="https://github.com/NannerFox/React-HashRouter" target="_blank" color="primary"><i className="fas fa-code"></i> View Code</Button> <Button href="https://nannerfox.wordpress.com/2018/07/16/the-scenic-route/" target="_blank" color="primary"><i className="fab fa-wordpress-simple"></i> View Blog Post</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://awjavascriptquiz.herokuapp.com/" target="_blank" color="primary"><i class="far fa-eye"></i> Live Site</Button> <Button href="https://github.com/NannerFox/JavaScript-Quiz" target="_blank" color="primary"><i className="fas fa-code"></i> View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://github.com/NannerFox/BingBong" target="_blank" color="primary"><i className="fas fa-code"></i> View Code (1)</Button> <Button href="https://github.com/NannerFox/FizzBuzz" target="_blank" color="primary"><i className="fas fa-code"></i> View Code (2)</Button> <Button href="https://nannerfox.wordpress.com/2018/09/17/fizz-buzz-killington/" target="_blank" color="primary"><i className="fab fa-wordpress-simple"></i> View Blog Post</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://github.com/NannerFox/Ionic-ToDo" target="_blank" color="primary"><i className="fas fa-code"></i> View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://github.com/NannerFox/Fibonacci-Counter" target="_blank" color="primary"><i className="fas fa-code"></i> View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://github.com/NannerFox" target="_blank" color="primary"><i className="fab fa-github"></i> Visit Site</Button>
        </Col>
      </Row>
    </Jumbotron>
  </Fade>
