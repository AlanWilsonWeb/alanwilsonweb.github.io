    ...
    <Jumbotron className="bg-dark">
      ...
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://moviefive.herokuapp.com" target="_blank" color="info">Live Site</Button> <Button href="https://github.com/5-28-a/group-project" target="_blank" color="primary">View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://nannerfox.herokuapp.com" target="_blank" color="info">Live Site</Button> <Button href="https://github.com/NannerFox/React-HashRouter" target="_blank" color="primary">View Code</Button> <Button href="https://nannerfox.wordpress.com/2018/07/16/the-scenic-route/" target="_blank" color="success">View Blog Post</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://awjavascriptquiz.herokuapp.com/" target="_blank" color="info">Live Site</Button> <Button href="https://github.com/NannerFox/JavaScript-Quiz" target="_blank" color="primary">View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          <h2><u>BingBong!</u></h2>
          FizzBuzz? BingBong? It goes by many names in the Developer world, but every iteration holds the same requirement: display a list of numbers which will also output one of these keywords upon the event that a certain operator is met. This is a common JavaScript interview question, and my take on the time-honored classic.
          <br />
          <Button href="https://github.com/NannerFox/BingBong" target="_blank" color="primary">View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://github.com/NannerFox/Ionic-ToDo" target="_blank" color="primary">View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://github.com/NannerFox/Fibonacci-Counter" target="_blank" color="primary">View Code</Button>
        </Col>
      </Row>
      <br />
      <Row className="portfolioRow">
        ...
        <Col md="8">
          ...
          <br />
          <Button href="https://github.com/NannerFox" target="_blank" color="primary">Visit Site</Button>
        </Col>
      </Row>
    </Jumbotron>
  </Fade>
